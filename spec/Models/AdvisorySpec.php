...
class AdvisorySpec extends ObjectBehavior
{
    ...
    {
        $this->getAdvisoryLink()->shouldReturn('https://github.com/Seldaek/monolog/pull/448#issuecomment-68208704');
    }

    function it_should_be_able_to_get_the_advisory_title()
    {
        $this->getAdvisoryTitle()->shouldReturn('Header injection in NativeMailerHandler');
    }
}
